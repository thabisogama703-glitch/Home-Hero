...
namespace Home_Hero
{
    ...
    public class MaintenanceRequest1
    {
        ...
        public MaintenanceRequest1() { }
        public MaintenanceRequest1(string customerId, string category, string description, string address, DateTime preferredDate, string preferredTime)
        {
        ...
        public MaintenanceRequest1(Customer customer, Service1 service, string requestDescription)
        {
