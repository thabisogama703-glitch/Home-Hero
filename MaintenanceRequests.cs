...
namespace ServiceProviderDashboard
{
    public class MaintenanceRequests
    {
        ...
        public MaintenanceRequests(Customer customer,Service service,string description)
        {
       ...
       public bool ScheduledAppointmentValidation(MaintenanceRequests maintenanceRequest,ServiceProvider assignedProvider,DateTime dateTime,out Appointment scheduledAppointment,out string error)
        {
